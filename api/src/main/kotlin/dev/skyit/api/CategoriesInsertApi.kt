...
import dev.skyit.model.InlineObject1
import dev.skyit.model.InlineResponse200
...
class CategoriesInsertApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun insertCategoriesParam(body: InlineObject1?) : InlineResponse200 {
